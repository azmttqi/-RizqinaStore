...
export default function LoginPage() {
  ...
  async function handleGoogleLogin() {
    ...
    // Sign-in will redirect away from the page
  }
      ...
      <div className="w-full max-w-[420px] animate-fade-in">
        ...
        <div className="glass-card" style={{ padding: '2rem' }}>
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1.75rem' }}>
            ...
            <div className="form-group">
              <label htmlFor="password" style={{ marginBottom: '0.625rem', fontWeight: 600 }}>Password</label>
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  style={{ paddingRight: '3rem', height: '3.25rem' }}
                />
                <button
                  type="button"
